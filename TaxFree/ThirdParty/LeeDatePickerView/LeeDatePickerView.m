...
-(NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component{
    ...
    BOOL isSelected;
    if (component == 0) {
        string = [NSString stringWithFormat:@"%@",self.yearArray[row]];
        isSelected = (row == self.yearIndex);
    }else if (component == 1) {
        string = [NSString stringWithFormat:@"%@",self.monthArray[row]];
        isSelected = (row == self.monthIndex);
    }else if (component == 2){
        string = [NSString stringWithFormat:@"%@",self.dayArray[row]];
