...
//        [session setCategory:allow? AVAudioSessionCategoryPlayback : AVAudioSessionCategoryAmbient error:NULL];
        [session setCategory:allow? AVAudioSessionCategoryPlayAndRecord : AVAudioSessionCategoryAmbient withOptions:0xff  error:NULL];
//        AVAudioSessionCategoryOptionMixWithOthers | AVAudioSessionCategoryOptionInterruptSpokenAudioAndMixWithOthers
#endif
